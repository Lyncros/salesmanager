      ...
      <div class="row">
        ...
        <div class="col-sm-10 col-sm-offset-2 col-md-10 col-md-offset-2 main">
          <div class="row relative">
            ...
            <section class="col-sm-6 col-md-6 panel contact-detail">
            	<header class="panel-heading">
                	...
                	<div class="panel-actions text-right pull-right">
                        <a href="editar-contacto.php" data-toggle="tooltip" data-placement="top" title="Editar contacto"><span class="icon icon-edit"></span></a>
                        ...
                        <div class="alert alert-estatus" role="alert">
                            <div class="alert-heading row">
                                <div class="col-md-10">
                                    ...
                                    <h4 class="pull-left"><strong>Llamar</strong> Ofrecerle propiedad de Mitre 345.</h4>
                                </div>
                                <div class="col-md-2">
                        	...
                        	<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                              <article class="task panel">
                                <header class="panel-heading" role="tab" id="headingOne">
                                    ...
                                    <div class="pull-left task-edit btn-group">
                                        <a class="icon icon-edit btn btn-default btn-xs" data-toggle="modal" data-target="#editarTarea"></a>
                                        <a class="icon icon-trash btn btn-default btn-xs"></a>
                                    </div>
                                </header>
                                	...
                                	<article class="task panel">
                                    	<header class="panel-heading">
                                        	<div class="row">
                                                <div class="col-md-9">
                                                    <div class="pull-left task-edit btn-group">
                                                        <a class="icon icon-edit btn btn-default btn-xs" data-toggle="modal" data-target="#editarOperacion"></a>
                                                        <a class="icon icon-trash btn btn-default btn-xs"></a>
                                                    </div>
                                                    <h5 class="pull-left">Comprar inmueble <strong>$200.000</strong></h5>
                                                </div>
                                                <div class="col-md-3">
                                                    <p class="date black">Cierre: 25/9/2016</p>
                                                </div>
                                            </div>
                                            <div class="row panel-subtitle">
                                            	<div class="status ac"></div>
                    ...
                    <section>
                    	<article class="timeline">
                          ...
                          <div class="task-history">
                              <ul>
                                  <li><article class="task-closed"><p><small>15/10/2015 - 15:30hs</small></p><h5>Llamar por teléfono. Ofrecerle propiedad de Mitre 345.</h5></article></li>
                                  <li><article class="op-won"><p><small>15/10/2015 - 15:30hs</small></p><h5>Llamar por teléfono. Ofrecerle propiedad de Mitre 345.</h5></article></li>
                                  <li><article class="op-lost"><p><small>15/10/2015 - 15:30hs</small></p><h5>Llamar por teléfono. Ofrecerle propiedad de Mitre 345.</h5></article></li>
                                  <li><article class="task-closed"><p><small>15/10/2015 - 15:30hs</small></p><h5>Llamar por teléfono. Ofrecerle propiedad de Mitre 345.</h5></article></li>
                                  <li><article class="task-closed"><p><small>15/10/2015 - 15:30hs</small></p><h5>Llamar por teléfono. Ofrecerle propiedad de Mitre 345.</h5></article></li>
                              </ul>
                          </div>
